...
public class LightDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fetchBt = findViewById(R.id.fetch_dim_light);
        ...
        if(bundle!=null){
            ...
            resource = bundle.getString("valueType");
        ...
        rb8Hours = findViewById(R.id.radioButtonLight_8H);
        rb24Hours = findViewById(R.id.radioButtonLightDay);
        rb7Days = findViewById(R.id.radioButtonLightWeek);
        rb1Month = findViewById(R.id.radioButtonLightMonth);
        rb1Month.setChecked(true);
        radioGroup = findViewById(R.id.radio_group_light);
        MarkerView mv = new CustomMarkerView(this, R.layout.tv_content_view);
        lineChart = findViewById(R.id.light_chart);
        lineChart.setTouchEnabled(true);
        lineChart.setMarkerView(mv);
        configureLineChart();
        /* -------------------------------------------------- */

        viewModel.getLightValueLiveData(boardId).observe(this, new Observer<List<SensorValue>>() {
            @Override
        ...
        adapter.setUnitOfMeasure("lux");
        eventsTriggeredRecycler = findViewById(R.id.events_triggered_recycler_light);
